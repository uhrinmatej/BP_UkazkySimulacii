Úložisko obsahuje Jupyter notebooky, v ktorých sú implementované vybrané algoritmy simulácie stochastických procesov vrátane simulácií príkladov spomenutých v textovej časti bakalárskej práce.
